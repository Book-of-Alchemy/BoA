...
![raw.png](attachment:7d401e0d-ea4d-4c4c-9be9-a40c627732fb:raw.png)

# 📋목차

### [1️⃣프로젝트 개요 및 목표](https://www.notion.so/1ff2dc3ef51480ccada8d82f61aa748d?pvs=21)

### [2️⃣사용된 기술 스택](https://www.notion.so/1ff2dc3ef51480ccada8d82f61aa748d?pvs=21)

### [3️⃣게임 사이클](https://www.notion.so/1ff2dc3ef51480ccada8d82f61aa748d?pvs=21)

### [4️⃣기술적인 도전 과제](https://www.notion.so/1ff2dc3ef51480ccada8d82f61aa748d?pvs=21)

### [5️⃣트러블 슈팅](https://www.notion.so/1ff2dc3ef51480ccada8d82f61aa748d?pvs=21)

### [6️⃣사용자 개선 사항](https://www.notion.so/1ff2dc3ef51480ccada8d82f61aa748d?pvs=21)

### [7️⃣팀원 소개 및 연락처](https://www.notion.so/1ff2dc3ef51480ccada8d82f61aa748d?pvs=21)

---

프로젝트  소개 영상

https://youtu.be/r2rrU3A1IZ4

- [게임 트레일러 링크](https://youtu.be/r2rrU3A1IZ4)
...
> 조합의 서는 전략적 로그라이크 던전 탐험 게임으로 플레이어는 매번 **랜덤하게 생성되는 던전 맵**에서 **몬스터와 아이템을 탐색**하여 퀘스트를 클리어 합니다.
> 

🔱 퀘스트 목표 달성을 위해서 랜덤하게 생성되는 던전 맵 구조를 탐험할 수 있습니다.

![화면 캡처 2025-05-29 122954.png](attachment:3e11081b-40da-4cf3-a8cf-a4a558a4cb41:화면_캡처_2025-05-29_122954.png)

**던전 탐험을 통해** 획득한 재료를 활용하여 **30여 종의 강력한 아이템을** 제작할 수 있습니다.

![134454.gif](attachment:3611b529-cac2-4157-9608-ce67c0449ed5:134454.gif)

![134.gif](attachment:30e95c93-7e6f-414a-b463-c22f6ebde891:134.gif)

각 던전은 **환경 타일의 속성에 따라 다른 전투 반응**을 유도하고 단순한 공격이 아닌 **전략적 선택**이 요구됩니다.

![기름불.gif](attachment:ec0f1ac4-ca05-4e09-a81d-594e81eea7a5:기름불.gif)

![안개2.gif](attachment:6af0e36c-2736-4ce2-9fe4-9775718dd1a7:안개2.gif)

레벨업 시 **60종의 유물 중 랜덤으로 제시된 유물을** 통해 캐릭터의 능력을 강화합니다.

![112.gif](attachment:b004b357-0b20-4364-a9c4-bfe34376742f:112.gif)

![화면 캡처 2025-05-29 123050.png](attachment:016be328-e63e-4fb7-a58f-d8ec59f2f2d4:화면_캡처_2025-05-29_123050.png)

성장과 선택한 아이템을 통해 강력한 적에게 도전할 수 있습니다.

![보스.gif](attachment:5b861085-154e-4ff6-b3ea-7a7e1a9bfe93:보스.gif)

퀘스트 클리어 후에는 **남은 재료를 골드로 환전**할 수 있고 골드는 **영구적인 스탯 강화**에 사용되어 반복 도전의 재미를 더합니다.

![화면 캡처 2025-05-29 124218.png](attachment:e5d1ae8d-298d-4168-bb92-f22571797727:화면_캡처_2025-05-29_124218.png)

- 프로젝트 시작 시 목표와 달성한 성과
    - 던전 내 제작 → 전투 루프 (기본 전투 사이클)
        - 소모품 제작 시스템
        - 인벤토리
        - 턴 시스템
        - 전투에 필요한 기본 인터랙션
    ...
    - 랜덤 맵 생성 + 탐색 시스템
        ...
        - 재료/이벤트 배치
        - 몬스터 리젠 시스템
    - 마을 시스템 및 성장 루프(자원 회수 → 시설 투자 → 성장)
        - 퀘스트 클리어 시 보상
            - 메인 목표 클리어 시점에 남아 있는 재료를 마을 자원에 추가
            → 골드로 환전하여 골드 추가로 대체
        - 각 시설별 UI 및 기능 (대장간, 탐험기지 등)
            - 연구/보급/장비/유물 해금 등 → 연구, 퀘스트 수주만 구현
    - 후순위
        - 트랩 시스템
        - 바이옴 시스템
        - ~~생존 제약 시스템~~
...
![image.png](attachment:d07d6551-1ddd-4c7c-8899-b733cd90dda7:image.png)
...
![image.png](attachment:ceb612bb-a9a3-475a-ba97-b1f9bedc35a0:image.png)
