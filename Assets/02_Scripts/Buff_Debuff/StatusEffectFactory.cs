...
public static class StatusEffectFactory
{
    ...
    public static StatusEffect CreateEffect(int id, int value = 10, int remainingTime = 30, int tickInterval = 10, CharacterStats target = null)
    {
        ...
        switch (id)
        {
            ...
            case 220004: statusEffect = new Stuned(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220005: statusEffect = new Asleep(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220006: statusEffect = new Slowed(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220007: statusEffect = new Confused(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220008: statusEffect = new Blinded(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220009: statusEffect = new Burn(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220010: statusEffect = new Poison(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220011: statusEffect = new Bleed(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220012: statusEffect = new Shock(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220101: statusEffect = new AtkIncrease(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220102: statusEffect = new DefIncrease(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220103: statusEffect = new RootImmune(StatusEffectDic[id], value, remainingTime, tickInterval) ; break;
            case 220104: statusEffect = new StunImmune(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220105: statusEffect = new SleepImmune(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220106: statusEffect = new SlowImmune(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220107: statusEffect = new ConfuseImmune(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220108: statusEffect = new BlindImmune(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220109: statusEffect = new BurnImmune(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220110: statusEffect = new PoisonImmune(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220111: statusEffect = new BleedImmune(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220112: statusEffect = new ShockImmune(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220113: statusEffect = new Swift(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220114: statusEffect = new AllImmune(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220115: statusEffect = new Regeneration(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220116: statusEffect = new Shield(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            case 220117: statusEffect = new Invincible(StatusEffectDic[id], value, remainingTime, tickInterval); break;
            default: throw new Exception("Unknown status ID: " + id);
        }
