...
//        const string itemBasePath = "Assets/08_ScriptableObjects/Item/ItemDataBase/Item Data Base.asset";
//        var baseSO = AssetDatabase.LoadAssetAtPath<ItemDataBase>(itemBasePath);
//        baseSO.itemDatas.Clear();
...
//            if(baseSO != null)
//            {
//                baseSO.itemDatas.Add(so);
//                EditorUtility.SetDirty(baseSO); // 변경사항 표시
//            }
//        }
...
//        const string recipeBasePath = "Assets/08_ScriptableObjects/Item/ItemDataBase/Item Data Base.asset";
//        var baseSO = AssetDatabase.LoadAssetAtPath<ItemDataBase>(recipeBasePath);
//        baseSO.recipeDatas.Clear();
...
//        const string artifactBasePath = "Assets/08_ScriptableObjects/ArtifactDataBase/ArtifactDataBase.asset";
//        var baseSO = AssetDatabase.LoadAssetAtPath<ArtifactDataBase>(artifactBasePath);
//        baseSO.artifacts.Clear();
...
//        const string questtBasePath = "Assets/08_ScriptableObjects/QusetDataBase/Quest Data Base.asset";
//        var baseSO = AssetDatabase.LoadAssetAtPath<QuestDataBase>(questtBasePath);
//        baseSO.questData.Clear();
...
//        const string researchBasePath = "Assets/08_ScriptableObjects/ResearchDataBase/Research Data Base.asset";
//        var baseSO = AssetDatabase.LoadAssetAtPath<ResearchDataBase>(researchBasePath);
//        baseSO.researchData.Clear();
...
//        const string soundBasePath = "Assets/08_ScriptableObjects/SoundDataBase/Sound Data Base.asset";
//        var baseSO = AssetDatabase.LoadAssetAtPath<SoundDataBase>(soundBasePath);
//        baseSO.soundDatas.Clear();
